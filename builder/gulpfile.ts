...
import { flashusersettings, usersettings_create_partition_binary, usersettings_distribute_ts, usersettings_generate_cpp_code, usersettings_generate_partition_content } from "./gulpfile_usersettings";
...
exports.build = gulp.series(
  clean,
  usersettings_generate_partition_content,
  usersettings_create_partition_binary,
  usersettings_generate_cpp_code,
  usersettings_distribute_ts,
  snsct.copy_flatbuffer_sources_from_sensact_generated,
  snsct.fill_template_sendcommands,
  snsct.fill_template_sensactapps,
